...
void AppADC_RegInjInit(DriverStructTypedef* pDX)  //init ADC1
{
    ...
    ADC_InitStructure.ADC_ContinuousConvMode = DISABLE; //can not ENABLE,or DMA will overrun
    ...
    ADC_RegularChannelConfig(ADC1, ADC_Channel_4,  1, ADC_SampleTime_28Cycles);  //DCBUS_V
    ...
    pDX->CurU.AdcOffset = ADC_GetInjectedConversionValue(ADC1,ADC_InjectedChannel_1);
    pDX->CurV.AdcOffset = ADC_GetInjectedConversionValue(ADC2,ADC_InjectedChannel_1);
    pDX = pDX + 1;
    pDX->CurU.AdcOffset = ADC_GetInjectedConversionValue(ADC1,ADC_InjectedChannel_2);
    pDX->CurV.AdcOffset = ADC_GetInjectedConversionValue(ADC2,ADC_InjectedChannel_2);
