...
#if !defined (sEE_M24C16) && !defined (sEE_M24C64_32)
/* Use the defines below the choose the EEPROM type */
/* #define sEE_M24C16*/  /* Support the device: M24C08. */
...
#if defined (sEE_M24C16)
 #define sEE_PAGESIZE           16
 #define EEPROM_SIZE            2048        //unit:bytes
...
extern __IO uint8_t*  sEEDataWritePointer;
