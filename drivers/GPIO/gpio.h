...
#define _DRIVE1_ON          TIM_CtrlPWMOutputs(TIM1, ENABLE)   //enable time1 output
#define _DRIVE1_OFF         TIM_CtrlPWMOutputs(TIM1, DISABLE)   //enable time1 output
...
#define OLED_D0_PORT        GPIOA
#define OLED_D0_PIN         GPIO_Pin_10
#define _OLED_D0_SET		GPIO_SetBits(OLED_D0_PORT ,OLED_D0_PIN)
#define _OLED_D0_RESET		GPIO_ResetBits(OLED_D0_PORT ,OLED_D0_PIN)

#define OLED_D1_PORT		GPIOA
#define OLED_D1_PIN			GPIO_Pin_9
#define _OLED_D1_SET		GPIO_SetBits(OLED_D1_PORT ,OLED_D1_PIN)
#define _OLED_D1_RESET		GPIO_ResetBits(OLED_D1_PORT ,OLED_D1_PIN)

#define OLED_RST_PORT        GPIOD
#define OLED_RST_PIN         GPIO_Pin_9
#define _OLED_RST_SET		GPIO_SetBits(OLED_RST_PORT ,OLED_RST_PIN)
#define _OLED_RST_RESET		GPIO_ResetBits(OLED_RST_PORT ,OLED_RST_PIN)

#define OLED_DS_PORT		GPIOD
#define OLED_DS_PIN			GPIO_Pin_8
#define _OLED_DS_SET		GPIO_SetBits(OLED_DS_PORT ,OLED_DS_PIN)
#define _OLED_DS_RESET		GPIO_ResetBits(OLED_DS_PORT ,OLED_DS_PIN)
...
typedef union
{
    ...
    struct
    {
		...
		AppGpioPropertyTypedef  OLED_D0;
		AppGpioPropertyTypedef  OLED_D1;
		AppGpioPropertyTypedef  OLED_RST;
		AppGpioPropertyTypedef  OLED_DS;
