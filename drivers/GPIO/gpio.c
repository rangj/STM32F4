...
const UNION_APP_GPIO_INIT_TYPEDEF  AppGpioInitTab =
{
	...
	.Split.OLED_D0.Port = OLED_D0_PORT,
	.Split.OLED_D0.Pin = OLED_D0_PIN,
    .Split.OLED_D0.Mode = GPIO_Mode_OUT,
    .Split.OLED_D0.Speed = GPIO_Speed_100MHz,
    .Split.OLED_D0.Otype = GPIO_OType_PP,
    .Split.OLED_D0.Pud = GPIO_PuPd_UP,

	.Split.OLED_D1.Port = OLED_D1_PORT,
	.Split.OLED_D1.Pin = OLED_D1_PIN,
    .Split.OLED_D1.Mode = GPIO_Mode_OUT,
    .Split.OLED_D1.Speed = GPIO_Speed_100MHz,
    .Split.OLED_D1.Otype = GPIO_OType_PP,
    .Split.OLED_D1.Pud = GPIO_PuPd_UP,

	.Split.OLED_RST.Port = OLED_RST_PORT,
	.Split.OLED_RST.Pin = OLED_RST_PIN,
    .Split.OLED_RST.Mode = GPIO_Mode_OUT,
    .Split.OLED_RST.Speed = GPIO_Speed_100MHz,
    .Split.OLED_RST.Otype = GPIO_OType_PP,
    .Split.OLED_RST.Pud = GPIO_PuPd_UP,

	.Split.OLED_DS.Port = OLED_DS_PORT,
	.Split.OLED_DS.Pin = OLED_DS_PIN,
    .Split.OLED_DS.Mode = GPIO_Mode_OUT,
    .Split.OLED_DS.Speed = GPIO_Speed_100MHz,
    .Split.OLED_DS.Otype = GPIO_OType_PP,
    .Split.OLED_DS.Pud = GPIO_PuPd_UP,
...
void GpioInit(void)
{
    ...
    for(uint8_t i=0; i<MAX_APP_GPIO_NUM; i++)
    {
...
void InitLogicVoltErrInterrupt(void)
{
    ...
    SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOB, EXTI_PinSource2);     //for LV_ERR	  低压报警
...
void EXTI2_IRQHandler(void)
{
    if(EXTI_GetITStatus(EXTI_Line2) != RESET)
    {
        ...
        //sEE_WriteBuffer(&DXC.PlatformInfo.Pos.AllPulse.All8s[0], 160, 4);  //32bit AB pulse
